...
export default function SpeakTheLanguage() {
  ...
  return (
    <div style={{backgroundColor:'black', textAlign:'left'}}>
      ...
      <div className='p-4'><h4><strong>AIverse</strong></h4></div>
      <div className='container'>
        <div className='row p-4'>
          <div className='col-12 col-md-8 mt-2' style={{color:'rgb(176, 176, 176)', fontSize:'14px'}}>
            <div className='' >
              <div style={{borderRadius:'25px', backgroundColor:'#fdca41',width:'80px',color:" #a884db", padding:'2px 10px', fontSize:'10px'}}><span>MINI GUIDE</span></div>
            </div>
        ...
        <div className='row p-3' style={{fontSize:'12px'}}>
          <div className='col-12 col-md-3' style={{borderRadius:'25px', backgroundColor:'white', border:'10px solid black',}}>
            <div style={{borderRadius:'25px', margin:'12px'}}><img style={{borderRadius:'25px',}} src={stl1} width='100%' height="auto"/></div>
            <p style={{borderRadius:'25px', margin:'12px'}}><strong>Tokens</strong> <br/>Basic units that can be encoded. Words are converted to language machines understand.</p>
          </div>
          <div className='col-12 col-md-6' style={{borderRadius:'25px', backgroundColor:'rgb(232, 247, 247)', border:'10px solid black'}}>
          ...
          <div className='col-12 col-md-3' style={{borderRadius:'16px', backgroundColor:'white', border:'10px solid black'}}>
          <div style={{borderRadius:'25px', margin:'12px'}}><img style={{borderRadius:'25px',}} src={stl2} width='100%' height="auto"/></div>
          ...
          <div className='col-12 col-md-8' style={{borderRadius:'25px', backgroundColor:'rgb(238, 232, 247)', border:'10px solid black'}}>
          ...
          <div className='col-12 col-md-4' style={{ border:'7px solid black',paddingRight:'0px', paddingLeft:'0px'}}>
            <img style={{borderRadius:'25px',}} src={stl3} width='100%' height="100%"/>
          </div>
          <div className='col-12' style={{fontSize:'18px',borderRadius:'25px',color:'white', backgroundColor:'#a884db', border:'10px solid black', position:'relative', height:'auto', overflow:'hidden'}}>
          ...
          <div className='col-12 col-md-4' style={{borderRadius:'25px', backgroundColor:'rgb(255, 237, 199)', border:'10px solid black'}}>
          ...
          <p className='mt-4' style={{margin:'12px'}}><strong>Reinforcement Learning (RL)</strong></p>
            ...
            <div className='col-12 col-md-5' style={{textAlign:'center',borderRadius:'25px',border:'10px solid black',height:'250px',borderRadius:'20px', backgroundColor:'#262626',display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column'}}>
            ...
            <div className='col-12 col-md-3' style={{textAlign:'center',borderRadius:'14px',border:'10px solid black',height:'250px',backgroundColor:'#262626',display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column'}}>
            <img src={lock} style={{filter: 'grayscale(100%)'}} width={28} height={28}/>
              <p style={{color:'rgb(79, 79, 79)', fontSize:'15px', padding:'10px'}}>Coming soon.<br/>Subscribe above to get notified.</p>
          </div>
            <div className='col-12 col-md-4' style={{textAlign:'center',borderRadius:'25px',border:'10px solid black',height:'250px',borderRadius:'20px', backgroundColor:'#262626',display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column'}}>
            <img src={lock} style={{filter: 'grayscale(100%)'}} width={28} height={28}/>
            <p style={{color:'rgb(79, 79, 79)', fontSize:'15px', padding:'10px'}}>Coming soon.<br/>Subscribe above to get notified.</p>
          </div>
        </div>
